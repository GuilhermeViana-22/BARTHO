    ...
    <div class="col-xs-8 col-sm-6 col-md-6 col-lg-6 card-body text-banner ">
        <div class="card-banner">
            ...
            <div class="col-xs-8 col-sm-6 col-md-6 col-lg-6 card-body ">
                ...
                <a href="{{ route('ajudar.index') }}"><button type="button" id="btn-saiba-mais" class="btn btn-more-information text-banner-button"><i class="fas fa-paw"> Saiba mais </i></button></a>
