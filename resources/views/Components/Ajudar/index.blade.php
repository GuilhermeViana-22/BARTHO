...
{{--    @include('Components.Banner.index')--}}
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="timeline">
            <div class="row no-gutters justify-content-end justify-content-md-around align-items-start timeline-nodes hidden">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const cards = document.querySelectorAll('.timeline-nodes.hidden');
            let delay = 0;
            ...
            cards.forEach((card, index) => {
                ...
                delay += 1000; // Incrementa 1 segundo para cada card
            });
        });
    </script>
